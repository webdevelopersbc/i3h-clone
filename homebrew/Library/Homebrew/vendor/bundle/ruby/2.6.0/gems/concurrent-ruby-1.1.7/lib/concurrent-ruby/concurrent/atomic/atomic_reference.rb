...
module Concurrent
  ...
  #
  #   @see http://docs.oracle.com/javase/8/docshttp://127.0.0.1:3000/api/java/util/concurrent/atomic/AtomicReference.html
  #   @see http://docs.oracle.com/javase/8/docshttp://127.0.0.1:3000/api/java/util/concurrent/atomic/package-summary.html
  #
